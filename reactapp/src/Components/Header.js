        ...
        return (
            <>
                <div style={{ textAlign: 'center' }}>
                    <h1 style={{ fontSize: '3rem', color:"white" }}>Favorite Sports-Person</h1>
                    <h1 style={{ color: 'red' }}>Cristiano Ronaldo</h1>
                    <p style={{ fontSize: '20px',color:"white" }}>Cristiano Ronaldo dos Santos Aveiro GOIH ComM is a Portuguese professional footballer who plays as a forward for and captains both Saudi Professional League club Al Nassr and the Portugal national team.
